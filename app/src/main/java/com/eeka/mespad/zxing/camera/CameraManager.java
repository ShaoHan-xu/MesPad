...
package com.eeka.mespad.zxing.camera;
...
public final class CameraManager {
    ...
    public synchronized void openDriver(SurfaceHolder holder)
        ...
        try {
            configManager.setDesiredCameraParameters(theCamera, false, requestedCameraId);
            ...
            if (parametersFlattened != null) {
                ...
                try {
                    ...
                    configManager.setDesiredCameraParameters(theCamera, true, requestedCameraId);
